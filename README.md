...
- Afbeeldingen en een lees-meer-link zijn optioneel. Voeg meerdere afbeeldingen toe voor een carrousel met veegbediening en pijlen; sleep de afbeeldingen in de gewenste volgorde. Eén afbeelding behoudt de bestaande weergave. Zonder linktekst verschijnt “Lees meer”.
...
- Onder **Website-instellingen → Instagram** kies je **Profiel tonen** of **Post tonen**. De eerste optie toont het profiel van De Partiburen; de tweede toont het bericht (`/p/`) of de reel (`/reel/`) waarvan je de Instagram-link plakt. Bij profielweergave wordt de postlink genegeerd. Deelparameters worden automatisch verwijderd. Er zijn geen API-tokens of accountkoppeling nodig.
- Bij een lege of ongeldige postlink verschijnt een link naar het Instagram-profiel. Het gekozen profiel of bericht moet openbaar zijn en embedding toestaan.
- Sociale links, Spotify en de voettekst staan vast in de code.
